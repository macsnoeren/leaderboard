    ...
    try {
        ...
        $mail->Body = "
          ...
          <h2>Welkom $team_name!</h2>
             ...
             <p>Houd de stand in de gaten op het: <a href='$leaderboard_link' style='background: #667eea; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px; display: inline-block;'>Leaderboard</a></p>
